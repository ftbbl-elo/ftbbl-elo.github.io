...
var $author$project$Page$ViewDivision$init = F3(
	function (session, id, startWeek) {
		return _Utils_Tuple2(
			{
				deleteError: $elm$core$Maybe$Nothing,
				displayedWeek: A2($elm$core$Maybe$withDefault, 1, startWeek),
				division: $krisajenkins$remotedata$RemoteData$Loading,
				divisionId: id,
				games: $krisajenkins$remotedata$RemoteData$Loading,
				session: session,
				sortingMethod: $author$project$Page$ViewDivision$None,
		...
		switch (route.$) {
			...
			case 'ViewDivision':
				...
				return A3(
					...
					A3($author$project$Page$ViewDivision$init, session, id, $elm$core$Maybe$Nothing));
			case 'ViewDivisionWeek':
				var id = route.a;
				var week = route.b;
				return A3(
					$author$project$Page$wrapInitWith,
					...
					$author$project$Page$ViewDivisionPageMsg,
					A3(
						$author$project$Page$ViewDivision$init,
						session,
						id,
						$elm$core$Maybe$Just(week)));
...
var $author$project$Route$ViewDivisionWeek = F2(
	function (a, b) {
		return {$: 'ViewDivisionWeek', a: a, b: b};
	});
...
var $author$project$Route$matchRoute = $elm$url$Url$Parser$oneOf(
	_List_fromArray(
		[
			...
			A2(
			$elm$url$Url$Parser$map,
			$author$project$Route$ViewDivisionWeek,
			$elm$url$Url$Parser$oneOf(
				_List_fromArray(
					[
						A2(
...
var $author$project$Route$routeToString = function (route) {
	switch (route.$) {
		...
		case 'ViewDivisionWeek':
			var divisionId = route.a;
			var week = route.b;
			return '/Division/View/' + ($author$project$Model$Division$idToString(divisionId) + ('/' + $elm$core$String$fromInt(week)));
		case 'AddTeamToDivision':
			var divisionId = route.a;
		...
		default:
			var divisionId = route.a;
			var week = route.b;
			return '/Game/AddWeek/' + ($author$project$Model$Division$idToString(divisionId) + ('/' + ($elm$core$String$fromInt(week) + '#week')));
	}
};
			...
			default:
				if (msg.a.$ === 'Ok') {
					...
					var newCmd = _Utils_eq(
						...
						$author$project$Route$pushUrl,
						model.session.navkey,
						A2($author$project$Route$ViewDivisionWeek, model.divId, model.week)) : $elm$core$Platform$Cmd$none;
					return _Utils_Tuple2(
						_Utils_update(
							model,
...
var $author$project$Page$EditGame$getNextPage = function (data) {
	if (data.$ === 'Success') {
		var game = data.a;
		return A2($author$project$Route$ViewDivisionWeek, game.division.id, game.week);
	} else {
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$id('week')
								]),
							_List_fromArray(
								[
